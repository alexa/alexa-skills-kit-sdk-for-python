...
# For more info, check https://developer.amazon.com/docs/custom-skills/host-a-custom-skill-as-a-web-service.html#checking-the-signature-of-the-request
...
# For more info, check https://developer.amazon.com/docs/custom-skills/host-a-custom-skill-as-a-web-service.html#cert-verify-signature-certificate-url
...
# For more info, check https://developer.amazon.com/docs/custom-skills/host-a-custom-skill-as-a-web-service.html#timestamp
DEFAULT_TIMESTAMP_TOLERANCE_IN_MILLIS = 30000

# Maximum allowable tolerance in request timestamp.
# For more info, check https://developer.amazon.com/docs/smapi/skill-events-in-alexa-skills.html#delivery-of-events-to-the-skill
